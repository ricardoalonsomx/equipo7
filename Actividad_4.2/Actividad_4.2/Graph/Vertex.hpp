...
class Vertex {
    ...
    int conexiones_de_entrada;
    int conexiones_de_salida;
    
public:
    Vertex()
    {
        conexiones_de_entrada = 0;
        conexiones_de_salida = 0;
    }
    ...
    void addConexion();
    void removeConexion();
    int get_conexiones_salida();
    int get_conexiones_entrada();
...
template <class V, class E>
void Vertex<V,E>::addConexion()
{
    conexiones_de_entrada++;
}

template <class V, class E>
void Vertex<V,E>::removeConexion()
{
    conexiones_de_entrada--;
}

template <class V, class E>
int Vertex<V,E>::get_conexiones_salida()
{
    return conexiones_de_salida;
}

template <class V, class E>
int Vertex<V,E>::get_conexiones_entrada()
{
    return conexiones_de_entrada;
}

template <class V, class E>
std::ostream & operator <<(std::ostream & os, const Vertex<V,E> & vertex)
{
    os << "Registro: " << vertex.info << std::endl;
